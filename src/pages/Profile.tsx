...
import { User, Bell, Moon, Globe, Shield, LogOut, ChevronLeft, BookOpen, Award, Settings } from "lucide-react";
import { useState } from "react";

const menuItems = [
  { icon: User, label: "تعديل الملف الشخصي", desc: "الاسم، الصورة، البريد" },
  ...
  { icon: Award, label: "الشهادات", desc: "شهاداتي المعتمدة" },
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="gradient-primary px-6 pt-12 pb-14 rounded-b-[2.5rem] text-center relative">
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
          <div className="w-24 h-24 rounded-full bg-primary-foreground/20 backdrop-blur-sm border-4 border-primary-foreground/30 mx-auto flex items-center justify-center text-4xl mb-3">
            👤
          </div>
