...
export default function ReciterExams() {
  ...
  const renderCard = (exam: Exam, isUpcoming: boolean) => (
    ...
    >
      <Card className="p-4 border-border/60" dir="rtl">
        <div className="flex flex-row-reverse items-start justify-between gap-3">
          ...
          {!isUpcoming && exam.result && (
            <Badge
              ...
              className="gap-1 text-xs flex-row-reverse"
            >
              {exam.result === "passed" ? (
        ...
        <div className="flex flex-row-reverse items-center justify-between gap-2 mt-3 text-xs">
          <div className="flex flex-row-reverse items-center gap-1.5 text-muted-foreground">
        ...
        <div className="mt-3 pt-3 border-t border-border/40">
          <div className="flex flex-row-reverse items-center gap-1.5 mb-1.5 justify-start">
        ...
        {isUpcoming && (
          <div className="flex flex-row-reverse gap-2 mt-3">
            <Button
              ...
              className="gap-2 flex-1 flex-row-reverse"
            >
