...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden"
      style={{ background: "linear-gradient(160deg, hsl(var(--primary)) 0%, hsl(var(--turquoise-dark)) 40%, hsl(var(--turquoise-dark) / 0.8) 65%, hsl(43 55% 45% / 0.5) 85%, hsl(43 55% 40% / 0.6) 100%)" }}
    >
      {/* Decorative */}
