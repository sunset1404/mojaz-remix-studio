# Lovable AI prompt — durable video-call signaling backend
...
Do not deploy the frontend before this migration succeeds, because the branch reads and writes these columns during call setup.
